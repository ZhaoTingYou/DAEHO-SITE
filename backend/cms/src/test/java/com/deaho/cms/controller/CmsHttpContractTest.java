...
import com.deaho.cms.error.ApiExceptionHandler;
import com.deaho.cms.repository.CmsRepository;
import com.deaho.cms.security.AdminAuth;
import com.deaho.cms.service.CmsSnapshotService;
import com.deaho.cms.service.CmsStatusService;
import com.deaho.cms.service.EmailNotificationService;
import com.deaho.cms.service.MediaStorageService;
...
class CmsHttpContractTest {
  ...
  void servesImportExportAndStatusEndpoints() throws Exception {
    ...
    mvc.perform(get("/api/admin/export").header("x-admin-api-key", ADMIN_KEY))
        .andExpect(status().isOk())
        .andExpect(header().string("Content-Disposition", org.hamcrest.Matchers.containsString("deaho-cms-export-")))
  ...
  private Map<String, Object> statusPayload() {
    return Map.of(
        ...
        "database", Map.of("path", "jdbc:postgresql://localhost/deaho", "engine", "postgresql"),
