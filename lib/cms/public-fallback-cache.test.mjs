...
test('rendered CMS errors and not-found responses cannot become successful ISR fallbacks', () => {
  ...
  assert.doesNotMatch(publicContent, /Public CMS news item \$\{slug\} was not found/);
  assert.doesNotMatch(publicContent, /Public CMS collection item \$\{slug\} was not found/);
