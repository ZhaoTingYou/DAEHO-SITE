...
const pathSegmentLabels: Record<AdminLocale, Record<string, string>> = {
  zh: {
    ...
    back: '返回',
    story: '作品故事',
    commissionEyebrow: '咨询区眉标',
    ctaTitle: '咨询区标题',
    related: '相关作品',
    thumbnailLabel: '图库缩略图辅助文案',
    previousImage: '上一张图片辅助文案',
    nextImage: '下一张图片辅助文案',
    details: '细节',
    closing: '结尾区块',
    process: '流程',
  ...
  ko: {
    ...
    back: '돌아가기',
    story: '작품 이야기',
    commissionEyebrow: '문의 영역 상단 라벨',
    ctaTitle: '문의 영역 제목',
    related: '관련 작품',
    thumbnailLabel: '갤러리 썸네일 안내',
    previousImage: '이전 이미지 안내',
    nextImage: '다음 이미지 안내',
    details: '상세',
    closing: '마무리 섹션',
    process: '프로세스',
  ...
  en: {
    ...
    back: 'Back',
    story: 'Work story',
    commissionEyebrow: 'Inquiry eyebrow',
    ctaTitle: 'Inquiry title',
    related: 'Related works',
    thumbnailLabel: 'Gallery thumbnail label',
    previousImage: 'Previous image label',
    nextImage: 'Next image label',
    details: 'Details',
