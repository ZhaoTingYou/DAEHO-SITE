...
import {normalizeLoginName} from './auth-ui-core.mjs';
...
export function profileProvisioningRequest(subject, claims, registrationGrant = '') {
  ...
  const loginName = normalizeLoginName(claims?.['cognito:username']);
  return {
    path: '/v1/internal/profiles/from-authenticated-phone',
    body: {subject, phone, loginName, registrationGrant}
  };
}
