...
import {CmsBackendError, resetTelegramLiveChatTopicCreation} from '@/lib/cms/repositories';
...
export async function POST(
  ...
  try {
    return NextResponse.json(await resetTelegramLiveChatTopicCreation(sessionId));
  } catch (error) {
