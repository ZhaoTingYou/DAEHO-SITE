...
const expectedResponsiveFields = [
  ...
  ['mastery-creations', 'main', 'gallery.filters.background', 'mobileBackground'],
  ['mastery-creations-champion', 'main', 'background', 'mobileBackground'],
  ['mastery-creations-appointment', 'main', 'background', 'mobileBackground'],
  ['mastery-creations-bespoke', 'main', 'background', 'mobileBackground']
];
