...
export default async function AdminLoginPage({searchParams}: Props) {
  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[#101827] px-4 py-10 text-white">
      <section className="w-full max-w-[420px] rounded-lg border border-white/10 bg-white p-6 text-[#182033] shadow-2xl">
        ...
        <form action={loginAction} className="mt-6 grid gap-4">
          ...
          <button className="min-h-11 rounded-md bg-[#7a2230] px-4 text-sm font-semibold text-white transition hover:bg-[#101827]">
            Sign in
          </button>
        </form>
      </section>
